...
module.exports = [{
	...
	component: (
		<Row className="test-height" childPosition="left" size="8">
			{ Children.image }
		</Row>
	)
}, {
	...
	component: (
		<Row className="test-height" childPosition="right" size="8">
			{ Children.image }
		</Row>
	)
}, {
	...
	component: (
		<Row className="test-height" childPosition="top" size="8">
			{ Children.image }
		</Row>
	)
}, {
	...
	component: (
		<Row className="test-height" childPosition="bottom" size="8">
			{ Children.image }
		</Row>
	)
},{
	...
	component: (
		<Row className="test-height" childPosition="top-left" size="8">
			{ Children.image }
		</Row>
	)
},{
	...
	component: (
		<Row className="test-height" childPosition="top-center" size="8">
			{ Children.image }
		</Row>
	)
},{
	...
	component: (
		<Row className="test-height" childPosition="top-right" size="8">
			{ Children.image }
		</Row>
	)
},{
	...
	component: (
		<Row className="test-height" childPosition="bottom-left" size="8">
			{ Children.image }
		</Row>
	)
},{
	...
	component: (
		<Row className="test-height" childPosition="bottom-center" size="8">
			{ Children.image }
		</Row>
	)
},{
	...
	component: (
		<Row className="test-height" childPosition="bottom-right" size="8">
			{ Children.image }
		</Row>
	)
},{
	...
	component: (
		<Row className="test-height" childPosition="center" size="8">
			{ Children.image }
		</Row>
	)
},{
	...
	component: (
		<Row className="test-height" childPosition="middle-center" size="8">
			{ Children.image }
		</Row>
	)
}]